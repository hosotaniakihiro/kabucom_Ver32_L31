# ============================================================
# File   : alerts/ignition_alert.py
# Version: Ver1.0-PRO-IGNITION-ALERT
# ------------------------------------------------------------
# ✔ IGNITION検出通知
# ✔ Discord embed
# ✔ 日本語表示
...
def _normalize_rows(rows):
    ...
    try:
        ...
        logger.exception("[ignition_alert] normalize failed")
    ...
    try:
        ...
        for r in rows:
            ...
            try:
                ...
                logger.exception("[ignition_alert] row failed")

    except Exception:

        logger.exception("[ignition_alert] notify failed")