...
# Version: V1.0-EARLY-PROFIT-BREAKEVEN-GUARD
# ------------------------------------------------------------
...
def _get_extreme_after_entry(*, side: str, ctx: Any, price: float) -> tuple[float, float]:
    high = price
    low = price
...
def judge_early_profit_guard(
    *,
    ...
    take_profit_pct = _env_float("EARLY_TAKE_PROFIT_PCT", 0.0015)
    ...
    high_after_entry, low_after_entry = _get_extreme_after_entry(side=side, ctx=ctx, price=current_price)
